...
const Landing: React.FC = () => {
    ...
    window.onload = () => {
        ...
        gsap.fromTo(".landing", {opacity:1 , x:0 , y:0}, {opacity:.5 , x:0 , y:-1000 , duration:1.5 , delay:3.5});
        gsap.fromTo(".container", {opacity:1}, {opacity:1 , duration:1.5 , delay:3});
    }
        ...
        <div className="landingMessage" id="landing">
            <section>
                <div className="landing" id="landing-message">
                    <h1 className="welcome">Hellow!</h1>
                </div>
                ...
                <div className="container" id="container">
                    <div className="nav">
                        ...
                        <div className="social">
                            <a href="https://www.github.com/basileLeroy">
                                <svg className="github" fill="#6d6d6d" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="https://www.linkedin.com/in/basile-leroy">
                                <svg className="linkedin" fill="#6d6d6d" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
