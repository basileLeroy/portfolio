<footer>
    <div class="social">
        <a href="https://www.linkedin.com/in/basile-leroy/"><i class="icon ion-social-linkedin"></i></a>
        <a href="https://github.com/basileLeroy"><i class="icon ion-social-github"></i></a>
    </div>
